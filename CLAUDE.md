...
- Backend logic ada di `src/modules/{feature}/serverFn.ts` — gunakan `createServerFn` dari `@tanstack/react-start`
- Gunakan `.inputValidator()` pada `createServerFn` — **bukan** `.validator()`
